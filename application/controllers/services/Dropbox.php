...
class Dropbox extends CI_Controller
{
	...
	{
	   echo site_url("services/dropbox/access_dropbox");
		$params['key'] = '1juddgz2wk16729';
		$params['secret'] = 'dnr2movg0vgpjgr';
		
		$this->load->library('dropbox', $params);
		$data = $this->dropbox->get_request_token(site_url("services/dropbox/access_dropbox"));
